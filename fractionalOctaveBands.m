...
%  - 'FrequencyLimits': two-element vector containing the frequency limit
...
%    filter at which the limit frequencies are defined. Three options:
...
%    band edge, band centre, and higher band edge ([f1 fc f2]) [Hz]
...
%    inaccuracies. The error will be larger the further away the frequency
...
%    < 0.1 the number of rounding digits should be increased by 1.
%   
